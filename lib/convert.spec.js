...
describe('smoke conversion tools', () => {
  ...
  describe('should convert separate mocks to a mock collection', () => {
    it('should convert all separate mocks', async () => {
      await convert('test/mocks', 'collection', null, null);
...
Array [
  ...
  \\"get_test#mocks#api#version.json_\\": \\"{\\\\n  \\\\\\"version\\\\\\": \\\\\\"1.0\\\\\\",\\\\n  \\\\\\"debug\\\\\\": \\\\\\"{{query.debug}}\\\\\\"\\\\n}\\\\n\\",
  \\"get_test#mocks#user-agent.js\\": data => ({
    statusCode: 200,
    headers: {
  ...
  \\"test#mocks#headers.html_\\": \\"<!doctype html>\\\\n<html>\\\\n  <body>\\\\n    Request headers:\\\\n    <ul><{ Object.keys(headers).forEach(name => { }>\\\\n      <li>{{{name}}}: {{{headers[name]}}}</li><{ }); }>\\\\n    </ul>\\\\n  </body>\\\\n<html>\\\\n\\",
  \\"post+put_test#mocks#ping.js\\": data => ({
